        ...
        void getMemberByID()
        {
            try
            {
                ...
                if (dr.HasRows)
                {
                    while (dr.Read())
                    {
                        TextBox11.Text = dr.GetValue(0).ToString(); //full name
                        TextBox12.Text = dr.GetValue(10).ToString(); //account status
                        TextBox2.Text = dr.GetValue(1).ToString(); // DOB
                        TextBox3.Text = dr.GetValue(2).ToString(); // contact number
                        TextBox4.Text = dr.GetValue(3).ToString(); // Email ID
                        TextBox8.Text = dr.GetValue(4).ToString(); //State
                        TextBox5.Text = dr.GetValue(5).ToString(); // City
                        TextBox6.Text = dr.GetValue(6).ToString(); // Pincode
